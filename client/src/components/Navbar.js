  ...
  return (
    <nav className='n_head'>
      <div className='n_navbar'>
        <div className="n_logo"><Link to="/"><FontAwesomeIcon icon={faMask} style={{fontSize:"2rem"}} className={stopspin?'':"fa-beat-fade"}/><span></span>&nbsp;&nbsp;ADID</Link></div>
        <ul className='n_links'>
          <li className="n_li"><Link to="/">Home</Link></li>
          <li className="n_li"><Link to="/about">About Us</Link></li>
        </ul>
